                        ...
                        <div class="card">
                            ...
                            <div class="card-body collapse in">
                                <form action="{{ route('exams.store') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <label class="radio-inline">
                                                <input type="radio" name="exam_for" value="lesson" checked> {{ __('Lesson') }}
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="exam_for" value="teacher"> {{ __('Teacher') }}
                                            </label>
                                        </div>
                                    </div>

                                    <div id="lesson-group" class="form-group">
                                    ...
                                    <div id="teacher-group" style="display: none;">
                                        <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control @error('pass_degree') is-invalid @enderror"
                                                       id="pass_degree" name="pass_degree" value="{{ old('pass_degree', 0) }}"
                                                       min="0" required>
                                                @error('pass_degree')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
