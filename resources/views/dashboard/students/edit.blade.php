                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"
                                        id="basic-layout-tooltip">{{ __('dashboard.student.edit') }} {{ __('dashboard.student.title') }}
                                        #{{ $student->id }}</h4>
                                    ...
                                    <div class="card-block">
                                        ...
                                        <form class="form" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        for="mac_address">{{ __("dashboard.student.fields.mac_address") }}</label>
                                                    <input type="text" id="mac_address"
                                                           class="form-control @error('mac_address') is-invalid @enderror"
                                                           name="mac_address"
                                                           value="{{ isset($student) ? $student->mac_address : old('mac_address') }}"
                                                           placeholder="{{ __("dashboard.student.fields.mac_address") }}"
                                                           data-toggle="tooltip" data-trigger="hover"
                                                           data-placement="top"
                                                           data-title="{{ __("dashboard.student.fields.mac_address") }}">
                                                    @error('mac_address')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
