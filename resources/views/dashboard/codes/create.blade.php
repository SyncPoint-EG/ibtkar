    ...
    <div class="app-content content container-fluid">
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-xs-12 mb-1">
                    <h2 class="content-header-title">{{ __('dashboard.code.create') }}</h2>
                </div>
                <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
                    <div class="breadcrumb-wrapper col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ __('dashboard.code.create') }}
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-tooltip">{{ __('dashboard.code.create_new') }}</h4>
                                ...
                                <div class="card-body collapse in">
                                    <div class="card-block">
                                        <div class="card-text">
                                            <p>{{ __('dashboard.code.fill_required') }}</p>
                                        </div>

                                        <form class="form" method="POST" action="{{ route('codes.store') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-body">
        ...
        <div class="form-group">
            ...
            <select id="for" name="for" class="form-control @error('for') is-invalid @enderror" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="{{ __("dashboard.code.fields.for") }}">
                ...
                @foreach($forOptions as $option)
                    <option value="{{ $option }}" {{ old('for') == $option ? 'selected' : '' }}>
                        {{ ucfirst($option) }}
                    </option>
                @endforeach
            </select>
        ...
        <div class="form-group">
            ...
            <input type="text" id="code_classification" class="form-control @error('code_classification') is-invalid @enderror"
                   name="code_classification" value="{{ old('code_classification') }}"
