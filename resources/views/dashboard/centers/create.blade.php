        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-xs-12 mb-1">
                    <h2 class="content-header-title">{{ __('dashboard.center.create') }}</h2>
                </div>
                <div class="content-header-right breadcrumbs-right breadcrumbs-top col-md-6 col-xs-12">
                    <div class="breadcrumb-wrapper col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ __('dashboard.center.create') }}
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-tooltip">{{ __('dashboard.center.create_new') }}</h4>
                                ...
                                <div class="card-body collapse in">
                                    <div class="card-block">
                                        <div class="card-text">
                                            <p>{{ __('dashboard.center.fill_required') }}</p>
                                        </div>

                                        <form class="form" method="POST" action="{{ route('centers.store') }}" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-body">
            ...
            @enderror
                                            ...
                                            <div class="form-actions">
                                                <a href="{{ route('centers.index') }}" class="btn btn-warning mr-1">
