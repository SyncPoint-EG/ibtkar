        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-xs-12 mb-1">
                    <h2 class="content-header-title">{{ __('dashboard.subject.management') }}</h2>
                </div>
                    ...
                    <div class="col-xs-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('dashboard.subject.list') }}</h4>
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block card-dashboard">
                                    @can('create_subject')
                                        <a href="{{ route('subjects.create') }}" class="btn btn-primary mb-1">
                                            <i class="icon-plus2"></i> {{ __('dashboard.subject.add_new') }}
                                        </a>
                                    @endcan
                                </div>
