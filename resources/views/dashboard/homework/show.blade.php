        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-xs-12 mb-1">
                    <h2 class="content-header-title">{{ $homework->title }}</h2>
                </div>
            ...
            <div class="content-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card p-1">
                            <div class="card-header">
                                <h4 class="card-title">Homework Information</h4>
                            </div>
                            <div class="card-body">
                                <table class="table table-borderless">
                                    <tr>
                                        <td><strong>Lesson:</strong></td>
                                        <td>{{ $homework->lesson->title ?? 'N\A'}}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Due Date:</strong></td>
                                        <td>{{ $homework->due_date ? $homework->due_date->format('Y-m-d') : 'No due date' }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Total Marks:</strong></td>
                                        <td id="totalMarks">{{ $homework->total_marks }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>Questions:</strong></td>
                                        <td id="totalQuestions">{{ $homework->questions->count() }}</td>
                                    </tr>
                                    <tr>
                                ...
                                <div class="mt-2">
                                    <a href="{{ route('homework.edit', $homework) }}" class="btn btn-warning btn-sm">
                                        <i class="icon-pencil"></i> Edit Homework
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card p-1">
                            <div class="card-header">
                                <h4 class="card-title">Questions (<span id="questionsCount">{{ $homework->questions->count() }}</span>)</h4>
                            </div>
                            <div class="card-body">
                                <div id="questionsList">
                                    @forelse($homework->questions as $index => $question)
                                        @include('dashboard.homework.partials.question-item', ['question' => $question, 'index' => $index])
                                    @empty
    ...
    @section('page_scripts')
        ...
        `;
                ...
                questionForm.addEventListener('submit', function(e) {
                    ...
                    const url = isEditing
                        ? `/homework-questions/${editingQuestionId}`
                        : `/homework/{{ $homework->id }}/questions`;
        ...
        `;
                ...
                function editQuestion(questionId) {
                    // You would need to implement this to fetch question data and populate the form
                ...
                function deleteQuestion(questionId) {
                    if (confirm('Are you sure you want to delete this question?')) {
                        fetch(`/homework-questions/${questionId}`, {
                            method: 'DELETE',
                            headers: {
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content'),
                                'X-Requested-With': 'XMLHttpRequest'
                ...
                function updateStats() {
                    ...
                    document.getElementById('totalQuestions').textContent = questionsCount;

                    // Update total marks (you might want to calculate this from the questions)
                    // For now, just refetch or calculate from DOM
                }
