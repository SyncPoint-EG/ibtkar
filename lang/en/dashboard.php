...
return [
        ...
        'notification' => [
            ...
            'filters_help' => 'Leave filters empty to target everyone.',
            'recipient_label' => 'Send To',
            'recipient_students' => 'Students',
            'recipient_guardians' => 'Guardians',
            'recipient_both' => 'Students & Guardians',
            'stages_label' => 'Stages',
            'grades_label' => 'Grades',
            'divisions_label' => 'Divisions',
            'filters_leave_blank' => 'Leave blank to include everyone.',
            'title_label' => 'Notification Title',
            'body_label' => 'Notification Body',
            'body_hint' => 'Write the message that will be displayed inside the app.',
            'success' => 'Notification dispatched successfully.',
            'empty_recipients' => 'No recipients matched the selected filters.',
        ],
        'settings' => [
            'title' => 'Settings',
        ...
        'grade_plan' => [
            'title' => 'Grade Plan',
            'title_plural' => 'Grade Plans',
            'management' => 'Grade Plans Management',
            'list' => 'Grade Plans List',
            'create' => 'Create Grade Plan',
            'edit' => 'Edit Grade Plan',
            'delete' => 'Delete Grade Plan',
            'add_new' => 'Add New Grade Plan',
            'create_new' => 'Create New Grade Plan',
            'update' => 'Update Grade Plan',
            'update_info' => 'Update the information for this Grade Plan.',
            'fill_required' => 'Please fill in all required fields to create a new Grade Plan.',
            'delete_confirm' => 'Are you sure you want to delete this Grade Plan?',
            'created_successfully' => 'Grade Plan created successfully.',
            'create_error' => 'Error creating Grade Plan:',
            'updated_successfully' => 'Grade Plan updated successfully.',
            'update_error' => 'Error updating Grade Plan:',
            'deleted_successfully' => 'Grade Plan deleted successfully.',
            'delete_error' => 'Error deleting Grade Plan:',
            'no_records' => 'No Grade Plans found.',
            'currency' => 'EGP',
            'fields' => [
                'general_plan_price' => 'General Plan Price',
            ],
        ],
        'division' => [
            'title' => 'Division',
        ...
        'luckwheelitem' => [
            'title' => 'Luck wheel item',
            'title_plural' => 'Luck wheel items',
            'management' => 'Luck wheel items Management',
            'list' => 'Luck wheel items List',
            'create' => 'Create Luck wheel item',
            'edit' => 'Edit Luck wheel item',
            'view' => 'View Luck wheel item',
            'delete' => 'Delete Luck wheel item',
            'add_new' => 'Add New Luck wheel item',
            'create_new' => 'Create New Luck wheel item',
            'update' => 'Update Luck wheel item',
            'show' => 'Show Luck wheel item',
            'actions' => 'Actions',
            'no_records' => 'No Luck wheel items found.',
            'fill_required' => 'Please fill in all required fields to create a new Luck wheel item.',
            'update_info' => 'Update the information for this Luck wheel item.',
            'delete_confirm' => 'Are you sure you want to delete this Luck wheel item?',
            'fields' => [
                'key' => 'Key',
                'value' => 'Value',
                'type' => 'Type',
